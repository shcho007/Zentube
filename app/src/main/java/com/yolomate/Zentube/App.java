...
import com.yolomate.Zentube.report.AcraReportSenderFactory;
...
public class App extends Application {
    ...
    private void initACRA() {
        try {
            ...
            ErrorActivity.reportError(this, ace, null, null, ErrorActivity.ErrorInfo.make(UserAction.SOMETHING_ELSE, "none",
                    "Could not initialize ACRA crash report", com.yolomate.Zentube.R.string.app_ui_crash));
        }
    }
    ...
    public void initNotificationChannel() {
        ...
        final String id = getString(com.yolomate.Zentube.R.string.notification_channel_id);
        final CharSequence name = getString(com.yolomate.Zentube.R.string.notification_channel_name);
        final String description = getString(com.yolomate.Zentube.R.string.notification_channel_description);
