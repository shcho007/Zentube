...
public class ReCaptchaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.yolomate.Zentube.R.layout.activity_recaptcha);

        // Set return to Cancel by default
        setResult(RESULT_CANCELED);

        Toolbar toolbar = findViewById(com.yolomate.Zentube.R.id.toolbar);
        setSupportActionBar(toolbar);

        ActionBar actionBar = getSupportActionBar();
        if (actionBar != null) {
            actionBar.setDisplayHomeAsUpEnabled(true);
            actionBar.setTitle(com.yolomate.Zentube.R.string.reCaptcha_title);
            actionBar.setDisplayShowTitleEnabled(true);
        }

        WebView myWebView = findViewById(com.yolomate.Zentube.R.id.reCaptchaWebView);
