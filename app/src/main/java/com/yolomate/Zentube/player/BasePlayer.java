...
package com.yolomate.Zentube.player;
...
import com.yolomate.Zentube.history.HistoryRecordManager;
import com.yolomate.Zentube.player.helper.PlayerHelper;
import com.yolomate.Zentube.player.playback.MediaSourceManager;
import com.yolomate.Zentube.player.playback.PlaybackListener;
import com.yolomate.Zentube.playlist.PlayQueue;
import com.yolomate.Zentube.playlist.PlayQueueAdapter;

import com.yolomate.Zentube.R;
import org.schabi.newpipe.extractor.stream.StreamInfo;

import com.yolomate.Zentube.player.helper.AudioReactor;
import com.yolomate.Zentube.player.helper.CacheFactory;
import com.yolomate.Zentube.player.helper.LoadController;
    ...
    private void recover() {
        ...
        if (isCurrentWindowCorrect && currentSourceItem != null) {
            ...
            if (DEBUG) Log.d(TAG, "Rewinding to recovery window: " + currentSourceIndex +
                    " at: " + PlayerHelper.getTimeString((int)position));
    ...
    public void sync(@NonNull final PlayQueueItem item,
        ...
        if (currentSourceIndex != playQueue.getIndex()) {
            ...
            if (DEBUG) Log.d(TAG, "Rewinding to correct window: " + currentSourceIndex +
                    " at: " + PlayerHelper.getTimeString((int)startPos));
