...
import com.yolomate.Zentube.fragments.OnScrollBelowItemsListener;
import com.yolomate.Zentube.fragments.local.dialog.PlaylistAppendDialog;
import com.yolomate.Zentube.player.event.PlayerEventListener;
import com.yolomate.Zentube.player.helper.PlayerHelper;
import com.yolomate.Zentube.playlist.PlayQueueItem;
import com.yolomate.Zentube.playlist.PlayQueueItemBuilder;
import com.yolomate.Zentube.playlist.PlayQueueItemHolder;
...
public abstract class ServicePlayerActivity extends AppCompatActivity
    ...
    private void buildPlaybackSpeedMenu() {
        ...
        for (int i = 0; i < BasePlayer.PLAYBACK_SPEEDS.length; i++) {
            ...
            final String formattedSpeed = PlayerHelper.formatSpeed(playbackSpeed);
    ...
    private void buildPlaybackPitchMenu() {
        ...
        for (int i = 0; i < BasePlayer.PLAYBACK_PITCHES.length; i++) {
            ...
            final String formattedPitch = PlayerHelper.formatPitch(playbackPitch);
